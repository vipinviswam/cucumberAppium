...
public class AndroidAppDriver {
	 ...
	 private static AndroidDriver driver;
	    ...
	    public static AndroidDriver loadNexus5xOreo() throws MalformedURLException {
	        ...
	        File file = new File("/Users/abhananarayanan/Downloads/gradleWorkspace");
	        File fileApp = new File(file, "reddit-official-app-3-30-1.apk"); //set app filepath to /src/[name-of-apk-file]
	        DesiredCapabilities capibilities = new DesiredCapabilities();
	        capibilities.setCapability("avd", "Pixel"); //set the AVD (Android Virtual Device) to be launched
	        capibilities.setCapability("deviceName", "Pixel"); //set the name of the device to be launched (should be same as AVD)
	        ...
	        capibilities.setCapability("automationName", "UiAutomator2");
